...
@onready var ray_cast: RayCast2D = $Gun2Raycast
@onready var tracer_line: Line2D = $Gun2Raycast/Gun2BulletTrace
@onready var tracer_timer: Timer = $Gun2TracerTimer # Reference to a Timer node
...
func _on_gun_2_tracer_timer_timeout() -> void:
